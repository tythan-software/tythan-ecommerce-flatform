...
const Orders = () => {
  ...
  // Update order status
  const updateOrderStatus = async (orderId: string, status: string, paymentStatus: string | null = null) => {
    try {
      const dataToSend: UpdateOrderStatus = { status, paymentStatus };
      const response = await orderService.updateOrderStatus(orderId, dataToSend);
