import SettingsCategories, { Setting } from "@/types/Setting";
import { FaCog, FaUser, FaDatabase, FaShieldAlt , FaBell } from "react-icons/fa";
import { MdSecurity, MdNotifications } from "react-icons/md";

const Settings = () => {
  const settingsCategories: SettingsCategories[] = [
    {
